...
export const metadata: Metadata = {
  title: "Peak | Elevate Your Business with SaaS",
  description: "Transform your business operations with Peak's leading SaaS solutions.",
  openGraph: {
    title: "Peak | Elevate Your Business with SaaS",
    description: "Transform your business operations with Peak's leading SaaS solutions.",
    url: "https://peak.com",
    siteName: "Peak",
    images: [{ url: "/assets/logo.svg", alt: "Peak Logo" }],
    type: "website",
  },
  twitter: {
